...
Collection of notebooks containing my codes for [Machine Learning Practice Course](https://onlinedegree.iitm.ac.in/course_pages/BSCCS2008.html) from [IIT Madras Online Degree Programme in Data Science and Programming](https://onlinedegree.iitm.ac.in/index.html)(Diploma Level).
...
* Data preprocessing
  ...
  * Handling imbalance -  `RandomUnderSampler`, `RandomOverSampler`, `SMOTE`
...
### Lecture notes - provided by course team reference
### Cheatsheets - provided by course team for reference